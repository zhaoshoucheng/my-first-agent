...
import (
	...
	"github.com/shoucheng/my-first-agent/internal/llm/langchaingo/llms/openai/errorutil"
)
...
func (e errorMessage) messageWithDetails() string {
	return errorutil.MessageWithDetails(e.Error.Message, e.Error.Type, e.Error.Metadata)
}
